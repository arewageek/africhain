      ...
      <Card className="h-full bg-white/80 backdrop-blur-sm border border-gray-200/50 hover:border-accent/30 transition-all duration-500 overflow-hidden group relative">
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-br ${
            isEven ? "from-accent/5 via-transparent to-secondary/5" : "from-secondary/5 via-transparent to-accent/5"
          ...
          <div className="flex items-start justify-between mb-6">
            <div
              className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${
                isEven ? "from-accent to-accent/70" : "from-secondary to-secondary/70"
